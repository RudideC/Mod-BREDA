...
// Define el tipo de dispositivo y su clase
...
#define MCP3x6x_SPI_SPEED (1000000)                      //!< SPI SPEED Value

// Comandos rápidos (aún no se usan kel)
...
// Direcciones de registro del ADC, es dicer, somo como "cajas" en las que guardamos la información

#define MCP3x6x_ADR_ADCDATA   (MCP3x6x_SPI_ADR | (0x0 << 2))  //!< Register ADCDdata address (guardamos los datos obtenidos por el adc)
...
// no es lo mismo que lo de arriba (ya lo arregalara el gonsa) pero por ahora no se usa
...
// De aqui en adelante es terreno pantanoso, no lo toques kel
...
class MCP3x6x {
  ...
  status_t _fastcmd(uint8_t cmd) { return transfer(0x00, cmd, 0); }
 ...
 public:
  ...
  status_t transfer(uint8_t *data, uint8_t addr, size_t size = 1);
  status_t readReg(uint8_t *data, uint8_t addr, size_t size = 1);
  status_t writeReg(uint8_t *data, uint8_t addr, size_t size = 1);
  /**
   ...
   * @param pinMLCK
   */
  MCP3x6x(const uint16_t MCP3x6x_DEVICE_TYPE, SPIClass *theSPI, const uint8_t pinCS, const uint8_t pinIRQ, const uint8_t pinMCLK);
   ...
   * @return false
   */
  bool begin(void (*function)(void), uint16_t channelmask = 0, float vref = 0) ;
  ...
  inline status_t write(config0_t data) {
    return transfer(&data.raw, MCP3x6x_CMD_IWRITE | MCP3x6x_ADR_CONFIG0);
  }
  ...
  inline status_t write(config1_t data) {
    return transfer(&data.raw, MCP3x6x_CMD_IWRITE | MCP3x6x_ADR_CONFIG1);
  }
  ...
  inline status_t write(config2_t data) {
    return transfer(&data.raw, MCP3x6x_CMD_IWRITE | MCP3x6x_ADR_CONFIG2);
  }
  ...
  inline status_t write(config3_t data) {
    return transfer(&data.raw, MCP3x6x_CMD_IWRITE | MCP3x6x_ADR_CONFIG3);
  }
  ...
  inline status_t write(irq_t data) {
    return transfer(&data.raw, MCP3x6x_CMD_IWRITE | MCP3x6x_ADR_IRQ);
  }
  ...
  inline status_t write(mux_t data) {
    return transfer(&data.raw, MCP3x6x_CMD_IWRITE | MCP3x6x_ADR_MUX);
  }
  ...
  inline status_t write(scan_t data) {
    return transfer(data.raw, MCP3x6x_CMD_IWRITE | MCP3x6x_ADR_SCAN, 3);
  }
  ...
  inline status_t write(timer_t data) {
    return transfer(data.raw, MCP3x6x_CMD_IWRITE | MCP3x6x_ADR_TIMER, 3);
  }
  ...
  inline status_t write(offset_t data) {
    return transfer(data.raw, MCP3x6x_CMD_IWRITE | MCP3x6x_ADR_OFFSET, 3);
  }
  ...
  inline status_t write(gain_t data) {
    return transfer(data.raw, MCP3x6x_CMD_IWRITE | MCP3x6x_ADR_GAIN, 3);
  }
  ...
  inline status_t write(lock_t data) {
    return transfer(&data.raw, MCP3x6x_CMD_IWRITE | MCP3x6x_ADR_LOCK);
  }
  ...
  inline status_t write(crccfg_t data) {
    return transfer(data.raw, MCP3x6x_CMD_IWRITE | MCP3x6x_ADR_CRCCFG, 2);
  }
  /*
  inline status_t write(Settings data) {
    return transfer((uint8_t)data, MCP3x6x_CMD_IWRITE | MCP3x6x_ADR_CONFIG0, 27);
  }
  */
  ...
  inline status_t read(config0_t data) {
    return transfer(&data.raw, MCP3x6x_CMD_IREAD | MCP3x6x_ADR_CONFIG0);
  }
  ...
  inline status_t read(config1_t data) {
    return transfer(&data.raw, MCP3x6x_CMD_IREAD | MCP3x6x_ADR_CONFIG1);
  }
  ...
  inline status_t read(config2_t data) {
    return transfer(&data.raw, MCP3x6x_CMD_IREAD | MCP3x6x_ADR_CONFIG2);
  }
  ...
  inline status_t read(config3_t data) {
    return transfer(&data.raw, MCP3x6x_CMD_IREAD | MCP3x6x_ADR_CONFIG3);
  }
  ...
  inline status_t read(irq_t data) {
    return transfer(&data.raw, MCP3x6x_CMD_IREAD | MCP3x6x_ADR_IRQ);
  }
  ...
  inline status_t read(mux_t data) {
    return transfer(&data.raw, MCP3x6x_CMD_IREAD | MCP3x6x_ADR_MUX);
  }
  ...
  inline status_t read(scan_t data) {
    return transfer(data.raw, MCP3x6x_CMD_IREAD | MCP3x6x_ADR_SCAN, 3);
  }
  ...
  inline status_t read(timer_t data) {
    return transfer(data.raw, MCP3x6x_CMD_IREAD | MCP3x6x_ADR_TIMER, 3);
  }
  ...
  inline status_t read(offset_t data) {
    return transfer(data.raw, MCP3x6x_CMD_IREAD | MCP3x6x_ADR_OFFSET, 3);
  }
  ...
  inline status_t read(gain_t data) {
    return transfer(data.raw, MCP3x6x_CMD_IREAD | MCP3x6x_ADR_GAIN, 3);
  }
  ...
  inline status_t read(lock_t data) {
    return transfer(&data.raw, MCP3x6x_CMD_IREAD | MCP3x6x_ADR_LOCK);
  }
  ...
  inline status_t read(crccfg_t data) {
    return transfer(data.raw, MCP3x6x_CMD_IREAD | MCP3x6x_ADR_CRCCFG, 2);
  }
  /*
  inline status_t read(Settings data) {
    return transfer((uint8_t)data, MCP3x6x_CMD_IREAD | MCP3x6x_ADR_CONFIG0, 27);
  }
  */
...
{
  public:
  MCP3564(SPIClass *theSPI = &SPI, const uint8_t pinCS = SS, const uint8_t pinIRQ = 1, const uint8_t pinMCLK = 1)
      : MCP3x6x(MCP3564_DEVICE_TYPE, theSPI, pinCS, pinIRQ, pinMCLK){};
};
